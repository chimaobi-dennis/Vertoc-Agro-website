...
export default function About() {
  ...
  return (
    <main className="flex-grow">
      ...
      <Editable key={i} section="registrations" index={i} label="registration"><span className="inline-flex items-center gap-2 bg-card border border-border px-4 py-2 rounded-full">
      <Icon className="w-4 h-4 text-accent" />{r.label}{r.value ? ` — ${r.value}` : ''}</span></Editable>
      ) })}
      <Editable section="registrations" add label="registration" className="px-4 py-2 rounded-full text-xs" />
      </div>
      )}
      </div>
      <div className="grid md:grid-cols-2 gap-8 mb-16">
      <Editable section="mission" label="mission"><div className="bg-card border border-border p-8 md:p-10 rounded-2xl h-full">
      ...
      <Editable section="vision" label="vision"><div className="bg-card border border-border p-8 md:p-10 rounded-2xl h-full">
      ...
      <Editable key={i} section="values" index={i} label="value"><div className="bg-card border border-border p-6 rounded-2xl hover:-translate-y-1 transition-transform duration-200 h-full">
      ...
      <Editable section="values" add label="value" />
      </div>
      </>
      )}
